package com.wpolog.sprintcloud.mcsv.personas.infra.inputadapter.http.exeption;
...
import com.wpolog.sprintcloud.mcsv.personas.infra.inputadapter.http.responsehandler.ExeptionResponseHandler;
...
public class ExceptionGlobalResponse {
    ...
    public ResponseEntity<Object> exception(ConstraintViolationException e) {
        String message = e.getMessage();
        log.error(message, e);
        return ExeptionResponseHandler.generateResponse(MESSAGEEXEPTION + message, babRequest,  CodeError.DEFAULT_SYSTEM_ERROR_CODE);
    }
